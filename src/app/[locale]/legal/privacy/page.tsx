                            ...
                            <>
                                ...
                                <div className="card">
                                    ...
                                    <ul>
                                        ...
                                        <li>Identificadores de publicidad (con consentimiento)</li>
                                    ...
                                    <div className="table-scroll">
                                        <table>
                                            ...
                                            <tbody>
                                                ...
                                                <tr><td>Mostrar anuncios</td><td>Consentimiento</td></tr>
                                                {SHOW_PREMIUM_PUBLIC_INFO && <tr><td>Procesar suscripciones y beneficios premium</td><td>Ejecución del contrato</td></tr>}
                            ...
                            <>
                                ...
                                <div className="card">
                                    ...
                                    <ul>
                                        ...
                                        <li>Device or advertising identifiers (with consent)</li>
                                        {SHOW_PREMIUM_PUBLIC_INFO && <li>In-app purchase and subscription data (handled by App Store / Play Store)</li>}
                                    ...
                                    <div className="table-scroll">
                                        <table>
                                            ...
                                            <tbody>
                                                ...
                                                <tr><td>Display ads</td><td>Consent</td></tr>
                                                {SHOW_PREMIUM_PUBLIC_INFO && <tr><td>Manage subscriptions and Premium benefits</td><td>Contract performance</td></tr>}
                            ...
                            <>
                                <div className="card">
                                    ...
                                    <ul>
                                        ...
                                        <li><strong>Google AdMob:</strong> Publicidad personalizada. <a href="https://policies.google.com/privacy" target="_blank" rel="noopener">Política de privacidad de Google</a></li>
                                        {SHOW_PREMIUM_PUBLIC_INFO && <li><strong>Google Play / Apple App Store:</strong> Procesamiento seguro de compras y suscripciones</li>}
                                    </ul>
                                    <h3>Cookies y tecnologías de seguimiento</h3>
                                    <p>La App utiliza Firebase Analytics para recopilar datos de uso de forma agregada y anónima. Los usuarios que consientan podrán recibir anuncios personalizados mediante Google AdMob.</p>
                                </div>
                                {SHOW_PREMIUM_PUBLIC_INFO && (
                                    <div className="card">
                            ...
                            <>
                                <div className="card">
                                    ...
                                    <ul>
                                        ...
                                        {SHOW_PREMIUM_PUBLIC_INFO && <li><strong>Google Play / Apple App Store:</strong> Secure purchase and subscription processing</li>}
                                    </ul>
                            ...
                            <>
                                ...
                                <div className="card">
                                    ...
                                    <ul>
                                        ...
                                        {SHOW_PREMIUM_PUBLIC_INFO && <li><strong>Datos de suscripción:</strong> durante la vigencia del contrato y hasta 3 años después para cumplimiento fiscal</li>}
                            ...
                            <>
                                ...
                                <div className="card">
                                    ...
                                    <ul>
                                        ...
                                        {SHOW_PREMIUM_PUBLIC_INFO && <li><strong>Subscription data:</strong> during the contract and up to 3 years after for fiscal compliance</li>}
