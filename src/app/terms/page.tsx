...
import { t, termsTranslations } from '@/i18n/translations';
        ...
        <main id="main-content">
            ...
            <section className="page-intro">
                <div className="container">
                    <h2>{t(termsTranslations.title, lang)}</h2>
                    <p>{t(termsTranslations.subtitle, lang)}</p>
                    <span className="page-date">{t(termsTranslations.updated, lang)}</span>
                </div>
            </section>
                        ...
                        <>
                            ...
                            <div className="card">
                                ...
                                <ul>
                                    ...
                                    <li><strong>Suscripciones Premium:</strong> cuatro niveles con ventajas adicionales</li>
                                </ul>
                            </div>
                            <div className="card">
                        ...
                        <>
                            ...
                            <div className="card">
                                ...
                                <ul>
                                    ...
                                    <li><strong>Premium subscriptions:</strong> four tiers with additional benefits</li>
                                </ul>
                            </div>
                            <div className="card">
